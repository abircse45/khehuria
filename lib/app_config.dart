...
class AppConfig {
  static String copyright_text = "@ Khejuria " + this_year; //this shows in the splash screen
  static String app_name = "Khejuria"; //this shows in the splash screen
  ...
  static const DOMAIN_PATH = "khejuria.com"; //inside a folder
