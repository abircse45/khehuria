...
class _SplashState extends State<Splash> {
  ...
  Widget build(BuildContext context) {
    return CustomSplashScreen(
      ...
      image: Image.asset("assets/splash_screen_logo.png",height: MediaQuery.of(context).size.height,width: double.infinity,fit: BoxFit.cover,),
     //  backgroundImage:
     //      Image.asset("assets/splash_login_registration_background_image.png",height: MediaQuery.of(context).size.height,width: double.infinity,fit: BoxFit.contain,),
     // /// backgroundColor: MyTheme.splash_screen_color,
      photoSize: 150,
    //backgroundPhotoSize: 400,
...
class _CustomSplashScreenState extends State<CustomSplashScreen> {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        backgroundColor: HexColor("#825624"),
        body: InkWell(
              ...
              Padding(
                ...
                child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
SizedBox(height: 60,),
                        Image.asset("assets/app_logo.png",height: 100,width: 100,fit: BoxFit.contain,),
                        SizedBox(height: 20,),

                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Center(child: Text("مرحبا بكم في خجورية",style: TextStyle(fontSize: 20,color: Colors.white),textAlign: TextAlign.center,),),
                        ),
                        SizedBox(height: 20,),
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Center(child: Text("Khejuria-Premium Quality Dates Importer In Bangladesh",style: TextStyle(fontSize: 20,color: Colors.white),textAlign: TextAlign.center,),),
                        ),
