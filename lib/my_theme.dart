...
class MyTheme{
  ...
  static HexColor accent_color = HexColor("#825624");

  static HexColor soft_accent_color = HexColor("#825624");
  static HexColor splash_screen_color = HexColor("#825624");
  ...
  static HexColor golden = HexColor("#825624");
